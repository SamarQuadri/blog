      ...
      <div class="content">
        ...
        <form action="create.php" method="post">
            <div class="form-group">
              ...
              <input type="text" name="username" value="<?php echo $username;?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
            ...
            <div class="form-group">
              ...
              <input type="password" name="passwordconf" value="<?php echo $passwordconf;?>" class="form-control" id="exampleInputPassword1" placeholder="Password Conform">
            </div>
          ...
          <?php endif;?>
            ...
            <div class="button-group">
              <button type="submit" name="create-admin" class="btn btn-secondary">Add User </button>
          </form>
      </div>
    </div>
